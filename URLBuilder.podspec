Pod::Spec.new do |spec|
    ...
    spec.homepage         = 'https://github.com/Puasonych/URLBuilder'
    spec.license          = { :type => 'MIT', :file => 'LICENSE' }
    spec.author           = { 'Erik Basargin' => 'basargin.erik@gmail.com' }
    spec.social_media_url = 'https://twitter.com/Puasonych'
    spec.source           = { :git => 'https://github.com/Puasonych/URLBuilder.git', :tag => spec.version }
    spec.swift_version    = '5.0'

    spec.ios.deployment_target = '8.0'

    spec.source_files = 'Sources/URLBuilder/'
